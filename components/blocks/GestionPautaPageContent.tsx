                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-[minmax(260px,auto)]">
                        ...
                        <motion.div {...fadeInUp} className="md:col-span-8 p-10 rounded-[2rem] glass-card border border-white/5 bg-abisal-900/40 relative overflow-hidden group">
                            ...
                            <p className="text-slate-400 text-sm max-w-lg leading-relaxed">No encendemos pauta sin cimientos. Verificamos la calidad del dato que enviamos a Meta/Google, implementamos CAPI y diseñamos rutas de conversión optimizadas específicamente para el <em>buyer journey</em> de tu cliente ideal.</p>
                        </motion.div>
