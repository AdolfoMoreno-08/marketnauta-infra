            ...
            <section className="py-24 px-6 relative z-10">
                <div className="max-w-7xl mx-auto">
                    ...
                    <motion.div variants={staggerContainer} initial="hidden" whileInView="show" viewport={{ once: true }}
                        ...
                        {/* RETENER_01 — WhatsApp CRM (large) */}
                        <motion.div variants={cardVariant} whileHover={{ y: -4, transition: { duration: 0.2 } }}
                            className="md:col-span-7 p-6 md:p-10 rounded-[2rem] glass-card border border-marketnauta-primary/20 bg-abisal-900/60 relative overflow-hidden group flex flex-col md:flex-row items-center gap-10">
                            <div className="absolute inset-0" style={{ background: "radial-gradient(ellipse at top right, rgba(139,92,246,0.06), transparent 70%)" }} />
                            ...
                            <div className="flex-1 relative z-10">
                                ...
                                <p className="text-slate-400 text-sm leading-relaxed">El canal #1 de apertura en Perú convertido en motor de ventas. Flujos automatizados con intervención humana en cotización, seguimiento y recompra. Cada conversación registrada sobre tu propio dato.</p>
                            </div>
                        ...
                        {/* RETENER_02 — Recuperación carritos */}
                        <motion.div variants={cardVariant} whileHover={{ y: -4, transition: { duration: 0.2 } }}
                            ...
                            <p className="text-slate-400 text-sm leading-relaxed">Secuencias email + WhatsApp segmentadas por intención de compra. Atacamos directo al 40% de abandono por causas internas. Ventas que ya estaban a un clic, sin gastar en pauta.</p>
                            <div className="mt-6 flex items-center gap-2">
                                <RefreshCw className="w-3.5 h-3.5 text-marketnauta-primary" />
                                <span className="text-[10px] font-mono text-marketnauta-primary">Trigger automático &lt; 30 min</span>
                            </div>
                        </motion.div>

                        {/* RETENER_03 — Email comportamiento */}
                        <motion.div variants={cardVariant} whileHover={{ y: -4, transition: { duration: 0.2 } }}
                            ...
                            <p className="text-slate-400 text-sm leading-relaxed">Disparadores por lo que el usuario hace o deja de hacer: bienvenida, post-compra, reactivación. ROI alto porque llegan en el momento exacto. Medido server-side de punta a punta.</p>
                            <div className="mt-6 flex items-center gap-2">
                                <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" />
                                <span className="text-[10px] font-mono text-emerald-400">Event-triggered, no broadcast</span>
                            </div>
                        </motion.div>
                        ...
                        <motion.div variants={cardVariant} whileHover={{ y: -4, transition: { duration: 0.2 } }}
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-slate-400 text-sm leading-relaxed max-w-xl mb-6">
                                    La misma web, distinta para cada visitante. Adaptamos contenido y oferta según origen, industria y momento del funnel, usando los{" "}
