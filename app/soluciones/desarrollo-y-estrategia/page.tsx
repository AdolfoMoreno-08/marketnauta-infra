...
export default function DesarrolloEstrategiaPage() {
    ...
    return (
        <div className="min-h-screen bg-[#030712] overflow-x-hidden relative">
            ...
            {/* 2. BENTO GRID: INGENIERÍA CON VISIÓN DE NEGOCIO */}
            <section className="py-24 px-6 relative z-10">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-[minmax(260px,auto)]">
                        ...
                        {/* Tarjeta 2: SEO (Span 4) - Aplicamos p-6 md:p-10 */}
                        ...
                        {/* Tarjeta 3: Lógica de Datos (Span 5) - Aplicamos p-6 md:p-10 */}
